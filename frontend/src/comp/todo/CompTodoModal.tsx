...
import { optionType, optionMonth, optionWeek, optionWeekDay, optionDay, todoDetail } from './CompTodoOption';
    ...
    const setDetailItem = (detailAry: todoDetail[]) =>{
        ...
        detailAry.forEach((t : todoDetail) => {
            ...
            if ( typeof(t.TMONTH)   === 'number' && !tmpMonthAry.includes(t.TMONTH.toString())){
                ...
                tmpMonthOpt = optionMonth.find((v: optionType) => v.value === t.TMONTH.toString());
            ...
            if ( typeof(t.TWEEK)    === 'number' && !tmpWeekAry.includes(t.TWEEK.toString())){
                ...
                tmpWeekOpt = optionWeek.find((v: optionType) => v.value === t.TWEEK.toString());
            ...
            if ( typeof(t.TWEEKDAY) === 'number' && !tmpWeekdayAry.includes(t.TWEEKDAY.toString())){
                ...
                tmpWeekdayOpt = optionWeekDay.find((v: optionType) => v.value === t.TWEEKDAY.toString());
            ...
            if ( typeof(t.TDAY)     === 'number' && !tmpDayAry.includes(t.TDAY.toString())){
                ...
                tmpDayOpt = optionDay.find((v: optionType) => v.value === t.TDAY.toString());
